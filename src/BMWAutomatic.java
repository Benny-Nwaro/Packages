import com.benbackend.automobile.AutomaticCar;

public class BMWAutomatic extends AutomaticCar {
    ...
    public BMWAutomatic(String engineType, String carColour, String carType,
                        int numberOfSeats, String seatCover,
                        int headLamps, int rearLights,
                        int indicatorLights, int breakLights) {
